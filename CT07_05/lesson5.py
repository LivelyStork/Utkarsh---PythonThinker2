...
# fav = ['chips', 'burger', 'cheese', 'pizza', 'dumplings']
# fav.pop(2)
# fav.append("sushi")
# for food in fav:
#     print(food)
...
# heightlist = [160, 165, 158, 170, 162, 168, 159, 172, 164, 166]
# tall = max(heightlist)
# name1 = heightlist.index(tall)
# print("The tallest person is: " + namelist[name1])
# print("He/she is " + str(tall) + "cm tall ")
# short = min(heightlist)
# name2 = heightlist.index(short)
# print("The shortest person is: " + namelist[name2])
# print("He/she is " + str(short) + "cm tall ")
...
while poke1 == poke2:
    poke2 = random.choice(pokemons)
ind1 = pokemons.index(poke1)
ind2 = pokemons.index(poke2)
print(poke1 + " and " + poke2 + " are fighting each other! ")
if powers[ind1] > powers[ind2]:
    print(poke1 + " wins! ")
elif powers[ind1] < powers[ind2]:
    print(poke2 + " wins! ")
else:
    print("Its a tie! ")
